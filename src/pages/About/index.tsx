...
const AboutPage = () => {
  ...
  useEffect(() => {
    ...
    const resizeListener = () => {
      ...
      } else if (window.innerWidth >= theme.breakpoints.values.tablet
